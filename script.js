...
const WISHES = [
  ...
  { label: "On growth,", text: "Watching you become who you are becoming has been the best front-row seat of my life. Happy birthday to the person I admire most." },
  { label: "On small things,", text: "The playlists, the inside jokes, the way you say my name — I notice all of it, and I keep every single piece." },
...
const MISSIONS = [
  { icon: "🤗", text: "Receive your birthday hug." },
  { icon: "🍫", text: "Eat your favourite chocolate." },
  { icon: "🤳", text: "Take a selfie with me." },
  { icon: "🤫", text: "Tell me one secret." },
  { icon: "💃", text: "Dance with me for one song." },
  { icon: "🍰", text: "Feed me one bite of cake." },
  { icon: "😂", text: "Take a funny selfie." },
  { icon: "📍", text: "Choose our next date place." },
  { icon: "💌", text: "Give me one compliment." },
  { icon: "🎧", text: "Listen to our song, together." },
  { icon: "📖", text: "Tell me your favourite memory of us." },
  { icon: "☎️", text: "Call someone who makes you smile." },
  { icon: "🕯️", text: "Make a birthday wish out loud." },
  { icon: "📸", text: "Recreate our very first photo together." },
  { icon: "✍️", text: "Write down one goal for this new year." },
  { icon: "🎁", text: "Guess what's in your final gift." },
  { icon: "🥂", text: "Raise a toast to yourself." },
  { icon: "🌙", text: "Look at the sky for one full minute." },
  { icon: "💭", text: "Tell me a dream you haven't said out loud." },
  { icon: "🎶", text: "Hum the first song that comes to mind." },
  { icon: "🖐️", text: "Hold my hand for ten seconds, no talking." },
  { icon: "😘", text: "Give me a kiss on the cheek." },
  { icon: "✨", text: "Close your eyes for the final surprise." },
];
